...
def train_both_tasks_from_fold(nn, s, n_fold, epoch=160, period=2, lr=0.0001, two_times=False, batch_size=36, with_test=False):
    file_raw = home_repo + 'two-task-nn/nn' + str(nn) + '/test_conv_ae.h5'
...
if __name__ == '__main__':
    train_both_tasks(221, 5, two_times=False, batch_size=140, lr=0.0001, epoch=180, number_of_folds=5,
                     number_for_test=44)
