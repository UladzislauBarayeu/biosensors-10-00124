function [ mean_result ] = PCA_SVM_T2( task, Size_of_feat, KernelSVM,  fast, knn)
...
for subject_i=1:size_of_sub
    ...
    if fast
        if knn
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/fast/T2/knn',num2str(knn),'/');
        else
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/fast/T2/');
        end
    else
        if knn
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/slow/T2/knn',num2str(knn),'/');
        else
