function [ mean_result ] = PCA_SVM_T2_new( task, Size_of_feat, KernelSVM,  fast, knn,selected_channels, number_sub_channel)
...
for subject_i=1:size_of_sub
    ...
    if fast
        if knn
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/',name_folder,'/fast/T2/knn',num2str(knn),'/');
        else
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/',name_folder,'/fast/T2/');
        end
    else
        if knn
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/',name_folder,'/slow/T2/knn',num2str(knn),'/');
        else
            outputDir = strcat('Data/PCA_results/task',num2str(task),'/',name_folder,'/slow/T2/');
        end
    end
